  ...
  return (
    <section className="bg-white px-4 pb-20 pt-24 sm:px-6 sm:pb-28 sm:pt-28 md:pb-12 md:pt-32 lg:px-8 lg:pb-16 lg:pt-36">
      <div className="mx-auto max-w-4xl text-center lg:max-w-5xl">
        ...
        <blockquote className="mb-10 px-1 text-[clamp(1.1rem,2.4vw,1.65rem)] font-semibold leading-[1.45] text-[#081849] md:mb-12 md:px-4 md:text-[clamp(1.15rem,2.2vw,1.3rem)] lg:leading-[1.4]">
          &ldquo;{quote}&rdquo;
        </blockquote>
