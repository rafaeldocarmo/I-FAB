...
export const metadata = {
  title: "Terms of Use — iFAB",
  description:
    "The terms governing use of the International Foot and Ankle Biomechanics Community website.",
};

/**
 * iFAB is unincorporated, which shapes two clauses that a template would get
...
const SECTIONS: LegalSection[] = [
  {
    ...
    body: [
      ...
      "The site is run by the members of the Scientific Board of iFAB, the International Foot and Ankle Biomechanics Community. iFAB is an international network of academic researchers; it is not incorporated in any country and has no legal personality separate from its members. The board can be reached at info@i-fab.org.",
    ],
  },
  {
    heading: "About this website",
    body: [
      "This site provides information about iFAB, its scientific board, its mission, and its meetings, and carries a form through which you can express interest in joining the community or send a message to the board.",
  ...
  },
  {
    ...
    body: [
      "The iFAB name and logo, and the text and design of this site, belong to iFAB or its licensors and are protected by copyright and other rights. The meeting photographs published here are iFAB's own.",
      ...
      "If you appear in a meeting photograph on this site and would prefer it were not published, write to info@i-fab.org and we will remove it.",
    ],
  },
  {
    ...
    body: [
      ...
      "Submitting the form under the joining subject is an expression of interest and nothing more. It does not create membership, confer any status within iFAB, or oblige us to respond — iFAB keeps no formal membership register and runs no admission process.",
  ...
  },
  {
    ...
    body: [
      "We aim to keep the site available and its content accurate and current, but we do not guarantee either. Meeting dates, venues, and board composition may change, and the site may be unavailable for maintenance or for reasons beyond our control.",
  ...
  },
  {
    ...
    body: [
      "The site is offered free of charge and for information. To the fullest extent permitted by law, neither iFAB, nor the members of its Scientific Board, nor anyone operating the site on their behalf is liable for any loss or damage arising from your use of the site or from reliance on anything published on it — including loss arising from the site being unavailable, incomplete, out of date, or inaccurate, or from the content of any site we link to.",
  ...
  },
  {
    ...
    body: [
      "Because iFAB is not incorporated in any country, these terms do not name a single governing law or a single court with jurisdiction, and we make no attempt to require you to bring a claim somewhere far from home.",
...
export default function TermsPage() {
  return (
    <LegalDocument
      ...
      intro="These terms govern your use of the iFAB website. Please read them before using the site or submitting information through it."
      sections={SECTIONS}
    />
  );
}
