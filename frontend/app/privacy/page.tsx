 ...
 * enforced automatically on i-FAB's own copy and asked for on theirs. Do not
...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "If you write to info@i-fab.org, we hold your message. The i-FAB domain has no mailbox of its own, so mail sent to that address is received by Resend, our email provider, and forwarded on to the board members' institutional mailboxes — the email accounts their universities and employers provide. Your address, your message and any attachments pass through both.",
  ...
  },
  {
    ...
    body: [
      "The board members are academics, and they receive i-FAB correspondence in the mailboxes their own universities and employers provide. Your message is therefore read, and kept, inside email systems that those institutions run and that i-FAB does not administer.",
      "We tell you this plainly because it has a consequence we cannot engineer away: i-FAB can delete its own copy of a submission on a schedule, but it cannot reach into an employer's mail system to enforce one. See How long we keep your data.",
  ...
  },
  {
    ...
    body: [
      ...
      "The notification email sent to the board at the time is a second copy of the same details, and it sits in the recipient's institutional mailbox. Board members are asked to delete these messages once the four years are up, and we will not pretend to more than that: i-FAB cannot impose a deletion schedule inside a mail system somebody's employer runs. If you ask us to erase your data, we pass that request to every board member who received it.",
